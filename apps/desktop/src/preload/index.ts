...
const api: VideorcApi = {
  ...
  getYoutubeEmbedUrl: (videoId) => invoke('youtube-bridge:get-embed-url', videoId),
  ...
  setWindowGated: (gated) => invoke('app:set-window-gated', gated),
  ...
  openLivingTextOutput: () => invoke('livingText-output:open'),
  closeLivingTextOutput: () => invoke('livingText-output:close'),
  getLivingTextOutputState: () => invoke('livingText-output:get-state'),
  pushLivingTextOutput: (payload) => invoke('livingText-output:push', payload),
  onLivingTextOutputState: (callback) => subscribe('livingText-output:state', callback),
  onLivingTextOutputUpdate: (callback) => subscribe('livingText-output:update', callback),
  ...
  exportTextFile: (content, suggestedFileName) =>
    invoke('system:export-text-file', content, suggestedFileName),
