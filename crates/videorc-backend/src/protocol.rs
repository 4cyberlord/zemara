...
#[serde(rename_all = "camelCase")]
pub struct AdminConnectionSetParams {
    pub base_url: String,
    #[serde(default)]
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AdminConnectionTestParams {
    pub base_url: String,
    pub api_key: String,
}
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LivingTextSyncParams {
    pub translation_code: String,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LivingTextChapterParams {
    pub translation_code: String,
    pub book: String,
    pub chapter: i32,
}
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LivingTextDetectParams {
    pub translation_code: String,
    pub text: String,
}
