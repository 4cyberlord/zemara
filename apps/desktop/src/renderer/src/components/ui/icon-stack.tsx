...
/**
 * Layered-card illustration for empty/no-data states — ported from reui.io's
 * Icon Stack component (github.com/keenthemes/reui,
 * registry-reui/bases/radix/reui/icon-stack.tsx). Three overlapping cards
 * with a section-specific icon skewed onto the top card, used wherever a
 * section has nothing to show (not yet connected, failed to load, or
 * genuinely empty) instead of a plain single icon.
 */
