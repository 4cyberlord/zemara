...
export const DEFAULT_BASIC_ENTITLEMENTS: EntitlementsSnapshot = {
  ...
  capabilities: [
    ...
    },
    {
      ...
      state: 'disabled',
      reason: 'Multistreaming requires Zemara Premium. Basic can stream to one destination at HD.'
    },
    {
      featureId: 'cloud-ai',
      state: 'disabled',
      reason: 'Cloud AI is a Zemara Premium feature.'
    },
    {
      featureId: 'noise-cleanup',
      state: 'disabled',
      reason: 'Noise Cleanup requires Zemara Premium.'
    }
  ],
  limits: {
...
export function entitlementCapability(
  ...
  return {
    featureId,
    state: 'disabled',
    reason: 'This Zemara feature is not enabled.'
  }
}
...
export function entitlementDisabledReason(
  ...
  return capability.reason ?? 'This Zemara feature is not enabled.'
}
